...
export function Footer() {
  return (
    <footer className="bg-neon-navy">
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          {/* Copyright */}
          <p className="text-xs text-white/60 sm:flex-1">
          ...
          {/* Legal links */}
          <div className="flex items-center justify-end gap-3 text-[11px] text-white/40 sm:flex-1">
